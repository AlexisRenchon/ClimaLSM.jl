...
cur_dir = @__DIR__
#cur_dir="/Users/mitraasadollahi/Projects/CliMA/ClimaLSM.jl/experiments/integrated/US-LWW"
include(
    joinpath(
        cur_dir,
        "load_packages.jl",
...
global end_date = 2 + (end_year - 1) * 365#maximum(daily)
