...
g1 = FT(140) # Wang et al: 141 sqrt(Pa) for Medlyn model; Natan used 300.
g0 = FT(0.01)
soil_K_sat = FT(5e-7) # m/s, matches Natan
soil_vg_n = FT(2.05) # unitless
soil_vg_α = FT(0.032) # inverse meters
K_sat_plant = 7e-8 # m/s # seems much too small?
rooting_depth = FT(1.5) # from Natan
