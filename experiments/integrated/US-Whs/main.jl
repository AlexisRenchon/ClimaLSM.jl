...
cur_dir = @__DIR__
#cur_dir="/Users/mitraasadollahi/Projects/CliMA/ClimaLSM.jl/experiments/integrated/US-Whs"
include(
    joinpath(
        cur_dir,
        "load_packages.jl",
...
global end_year = 4#maximum(daily)
global start_date = 1 + (start_year - 1) * 365#maximum(daily)
global end_date = 1.5 + (end_year - 1) * 365#maximum(daily)
