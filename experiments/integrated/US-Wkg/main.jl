...
cur_dir = @__DIR__
#cur_dir="/Users/mitraasadollahi/Projects/CliMA/ClimaLSM.jl/experiments/integrated/US-Wkg"
include(
    joinpath(
        cur_dir,
        "load_packages.jl",
...
global start_year = 2#minimum(daily)
global end_year = 2#maximum(daily)
global start_date = 1 + (start_year - 1) * 365#maximum(daily)
global end_date = 170 + (end_year - 1) * 365#maximum(daily)
