...
κ_dry_val = FT(Soil.κ_dry(ρp, soil_ν, κ_solid, κ_air))
κ_sat_frozen_val = FT(Soil.κ_sat_frozen(κ_solid, soil_ν, κ_ice))
κ_sat_unfrozen_val = FT(Soil.κ_sat_unfrozen(κ_solid, soil_ν, κ_liq));
